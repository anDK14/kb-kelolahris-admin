...
class MobileFeatureContentsRelationManager extends RelationManager
{
    protected static string $relationship = 'mobileFeatureContents';

    protected static ?string $title = 'Konten Fitur Mobile';
